...
export default function HubMotoristasPage() {
    const opcoes = [
        {
            titulo: "Vincular Novo Motorista",
            descricao: "Registrar a ficha de um novo condutor parceiro, categorias de CNH e contatos.",
            icone: "➕",
            rota: "/dashboard/frota/motorista/cadastro"
        },
        {
            titulo: "Lista de Condutores",
            descricao: "Visualizar, pesquisar e gerenciar motoristas ativos e auditar validades de CNH.",
            icone: "🪪",
            rota: "/dashboard/frota/motorista/lista"
        }
    ];
            ...
            <div className="relative z-10 w-full flex-1 flex flex-col justify-center max-w-[1400px] mx-auto">
                <header className="w-full text-center border-b border-white/[0.05] pb-8 max-w-2xl mx-auto px-4 mb-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-black uppercase tracking-tight text-white leading-none">
                        Gestão de <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Motoristas</span>
                    </h1>
                </header>
